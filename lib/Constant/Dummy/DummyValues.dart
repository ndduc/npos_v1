List<Map<dynamic, dynamic>> dummyPayment = [
  {"id" : 0, "name" : "Cash", "event" : "CASH"},
  {"id" : 1, "name" : "Debit Card", "event" : "DEBIT"},
  {"id" : 2, "name" : "Credit Card", "event" : "CREDIT"},
  {"id" : 3, "name" : "Check", "event" : "CHECK"},
  {"id" : 4, "name" : "Money Order", "event" : "MONEY_ORDER"},
];

List<Map<dynamic, dynamic>> dummyItem = [
  {"id" : 0, "name" : "Product 1", "price" : "1.00"},
  {"id" : 1, "name" : "Product 2", "price" : "2.00"},
  {"id" : 2, "name" : "Product 3", "price" : "3.00"},
  {"id" : 3, "name" : "Product 4", "price" : "4.00"},
  {"id" : 4, "name" : "Product 5", "price" : "5.00"},
  {"id" : 5, "name" : "Product 6", "price" : "6.00"},
  {"id" : 6, "name" : "Product 7", "price" : "7.00"},
  {"id" : 7, "name" : "Product 8", "price" : "8.00"},
