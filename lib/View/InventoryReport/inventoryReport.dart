...
import 'package:npos/View/Component/Stateful/Menu/reportInventory.dart';

class InventoryReport extends StatefulWidget {
  @override
  _InventoryReport createState() => _InventoryReport();
}

class _InventoryReport extends State<InventoryReport> {
  ...
  Widget bodyContentEvent() {
    bodyContent = InventoryReportBody();
    //MainClientBody
    //MainMenuBody
