...
class MainEmployeeBody extends StatefulWidget {
  UserModel? userData;
  MainEmployeeBody({Key? key, this.userData}) : super(key: key);
  @override
  Component createState() => Component();
}

class Component extends State<MainEmployeeBody> {
  ...
  Widget mainItem() {
    return Employee(userData: widget.userData);
