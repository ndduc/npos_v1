...
import 'Component/mainVendor.dart';


class VendorManagement extends StatefulWidget {
  UserModel? userData;
  VendorManagement({Key? key, this.userData}) : super(key: key);
  @override
  Component createState() => Component();
}

class Component extends State<VendorManagement> {
  ...
  Widget bodyContentEvent() {
    bodyContent = VenBody(userData: widget.userData);
    return bodyContent;
  }
