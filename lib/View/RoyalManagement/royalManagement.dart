...
import 'package:npos/View/Component/Stateful/Menu/mainRoyal.dart';

class RoyalManagement extends StatefulWidget {
  @override
  _RoyalManagement createState() => _RoyalManagement();
}

class _RoyalManagement extends State<RoyalManagement> {
