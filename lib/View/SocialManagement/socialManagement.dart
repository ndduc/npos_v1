...
import 'package:npos/View/Component/Stateful/Menu/mainSocial.dart';

class SocialManagement extends StatefulWidget {
  @override
  _SocialManagement createState() => _SocialManagement();
}

class _SocialManagement extends State<SocialManagement> {
