...
import 'package:npos/View/LocationManagement/Component/Location.dart';


class MainLocationBody extends StatefulWidget {
  UserModel? userData;
  MainLocationBody({Key? key, this.userData}) : super(key: key);
  @override
  Component createState() => Component();
}

class Component extends State<MainLocationBody> {
  ...
  Widget mainItem() {
    return Location(userData: widget.userData);
