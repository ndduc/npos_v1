...
class MainSectionBody extends StatefulWidget {
  UserModel? userData;
  MainSectionBody({Key? key, this.userData}) : super(key: key);
  @override
  Component createState() => Component();
}

class Component extends State<MainSectionBody> {
                    ...
                    children: [
                      ...
                      Expanded(
                        ...
                        child: ListView.builder(
                            scrollDirection: Axis.vertical,
                            shrinkWrap: true,
                            itemCount: UIItem.sectionOptionList.length,
                            itemBuilder: (context, index) {
                              return InkWell(
                                  onTap: () {
                                    String event = UIItem.sectionOptionList[index]["event"];   // POS Menu
                                    switch(event) {
                                  ...
                                  child:  Container(
                                      ...
                                      child: Center(
                                          child: Text(
                                            UIItem.sectionOptionList[index]["name"],
                                            textAlign: TextAlign.center,
                                            style: const TextStyle(
                                                fontSize: 25,
                                                fontWeight: FontWeight.bold
  ...
  Widget mainItem() {
      return Section(userData: widget.userData);
