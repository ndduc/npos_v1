...
class SectionManagement extends StatefulWidget {
  UserModel? userData;
  SectionManagement({Key? key, this.userData}) : super(key: key);
  @override
  Component createState() => Component();
}

class Component extends State<SectionManagement> {
  ...
  Widget bodyContentEvent() {
    bodyContent = MainSectionBody(userData: widget.userData);
    return bodyContent;
  }
