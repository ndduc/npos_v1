...
class MainProductMannagementBody extends StatefulWidget {
  // Widget? bodyContent = MainMenuBody();
  // MainMenuBody();
  // MainMenuBody.withData(this.bodyContent);
  @override
  _MainProductMannagementBody createState() => _MainProductMannagementBody();
}

class _MainProductMannagementBody extends State<MainProductMannagementBody> {
  uiText uIText = uiText();
  uiImage uImage = uiImage();
  Widget bodyContent = MainProductMannagementBody();
  @override
  void initState() {
    super.initState();
  }
        ...
        children: [
          ...
          Row(
            children: [
              Expanded(
                  flex: 3,
                  child:  solidButton("Save To Batch")
              ),
              Expanded(
                  flex: 3,
                  child:  solidButton("Update Batch")
              ),
              Expanded(
                  flex: 3,
