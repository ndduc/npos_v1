...
class CheckoutRefundDialog extends StatefulWidget {
  UserModel? userModel;
  CheckoutRefundDialog({Key? key, required this.userModel}) : super(key: key);
  @override
  Component createState() => Component();
}

class Component extends State<CheckoutRefundDialog> {
            ...
            Expanded(
                ...
                Column(
                  children: [
                    ...
                    const Text(
                      "Follow the instruction to refund",
                      style: TextStyle(
                          fontSize: 20.0,
                    ...
                    Custom_ListTile_TextField(
                        controller: null,
                        read: readOnly,
                        labelText: "Scan/Enter Product Upc or ItemCode",
                        isMask: false,
                        isNumber:false,
                        mask: false
                    ),
                      ...
                      children: [
                        ...
                        Expanded(
                          /// Logic: Disable when number of void field left blank
                            flex: 2,
                            child: solidButton("REFUND", "REFUND")
                        )
                      ],
                    )
                  ],
